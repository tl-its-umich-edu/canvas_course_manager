      ...
      Courses.getCourses(url).then(function (result) {
        if (result.data.errors) {
          ...
          if(result.errors){
            ...
            var url='/canvasCourseManager/manager/api/v1/courses?as_user_id=sis_login_id:' +uniqname+ '&per_page=20&published=true&with_enrollments=true&enrollment_type=ta';
            Courses.getCourses(url).then(function (result) {
